...
public class FreeshipXtraAdapter extends RecyclerView.Adapter<FreeshipXtraAdapter.ViewHolder> {
    ...
    public FreeshipXtraAdapter(Context ctx, List<String> sTitles1, List<String> sTitles2, List<Integer> sImages){
